...
class AppColorScheme {
  ...
  static const light = AppColorScheme(
    ...
    boardBackground: Color(0xFFF1F5F9),
    cellBackground: Color(0xFFFFFFFF),
    cellSelected: Color(0xFFE0F2FE),
    cellHighlighted: Color(0xFFF8FAFC),
    cellPeer: Color(0xFFF1F5F9),
    cellMatched: Color(0x2838BDF8),
    cellConflict: Color(0xFFDC2626),
    cellConflictSoft: Color(0x28DC2626),
    cellSuccess: Color(0xFF16A34A),
    givenNumber: Color(0xFF1E293B),
    userNumber: Color(0xFF38BDF8),
    noteColor: Color(0xFF64748B),
    gridLine: Color(0xFFCBD5E1),
    gridLineThick: Color(0xFF94A3B8),
    ...
    heroGradient: LinearGradient(
      colors: [Color(0xFFFFFFFF), Color(0xFFF1F5F9), Color(0xFFFFFFFF)],
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    ),
  );
