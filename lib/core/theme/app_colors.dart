...
class AppColorScheme {
  ...
  static const dark = AppColorScheme(
    ...
    surfaceBorder: Color(0xFF2A3348),
    ...
    cellConflictSoft: Color(0x1BEA8E8A),
  ...
  static const light = AppColorScheme(
    ...
    cellSelected: Color(0xFFE3EDFC),
    cellHighlighted: Color(0xFFF5F7FA),
    cellPeer: Color(0xFFF0F3F8),
    cellMatched: Color(0x1A3B82F6),
    cellConflict: Color(0xFFDC2626),
    cellConflictSoft: Color(0x1FDC2626),
